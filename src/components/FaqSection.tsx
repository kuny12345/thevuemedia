...
const qas: { q: string; a: string }[] = [
  ...
  {
    q: "효과는 어떻게 확인하나요?",
    a: "자체 도구 AIRank로 구글 AI 개요·ChatGPT·Perplexity·Gemini·네이버 AI 등 여러 AI 엔진에 실제 질의를 보내, 브랜드가 언급되는지와 어떤 맥락으로 추천되는지를 주기적으로 추적합니다. 추적 결과는 대시보드로 제공되어, 작업 전후의 변화를 같은 기준으로 비교해 확인할 수 있습니다.",
  },
  {
  ...
  {
    q: "미팅은 어떻게 진행되나요?",
    a: "화상 미팅과 원격 협업으로 진행되어 지역 제약이 없습니다. 진단 리포트와 추적 데이터를 화면으로 함께 보며 논의하고, 지역 기반 검색이 중요한 업종은 해당 상권 정보에 맞춰 설계합니다.",
  },
  {
